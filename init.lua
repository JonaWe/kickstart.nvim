...
do
  ...
  vim.keymap.set('n', '<leader>fn', function() builtin.find_files { cwd = vim.fn.stdpath 'config' } end, { desc = '[F]find [N]eovim files' })
end
...
do
  ...
  vim.keymap.set('n', '<leader>co', function() gc.choose 'ours' end, { desc = '[G]it [C]onflict choose [O]urs' })
  vim.keymap.set('n', '<leader>ct', function() gc.choose 'theirs' end, { desc = '[G]it [C]onflict choose [T]heirs' })
  vim.keymap.set('n', '<leader>cb', function() gc.choose 'both' end, { desc = '[G]it [C]onflict choose [B]oth' })
end
